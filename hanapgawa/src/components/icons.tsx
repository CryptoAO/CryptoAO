// The app's icon system: a small, hand-tuned set of inline SVGs.
//
// Emojis stay out of the chrome on purpose — they render differently on
// every Android skin and read as decoration, not interface. These are
// consistent-stroke outline glyphs (24-unit grid, currentColor), so they
// inherit text color and align with type like any professional icon set.
// Category emojis (🧺, 🚗 …) are the one deliberate exception: they are
// data, seeded per category, and act as brand-friendly category glyphs.
